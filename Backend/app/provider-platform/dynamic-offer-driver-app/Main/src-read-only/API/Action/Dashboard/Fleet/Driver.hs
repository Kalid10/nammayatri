...
putDriverDashboardFleetWmbTripDelete :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> Dashboard.Common.TripTransactionId -> Environment.FlowHandler Kernel.Types.APISuccess.APISuccess)
putDriverDashboardFleetWmbTripDelete a3 a2 a1 = withDashboardFlowHandlerAPI $ Domain.Action.Dashboard.Fleet.Driver.putDriverDashboardFleetWmbTripDelete a3 a2 a1
